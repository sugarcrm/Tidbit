...
$GLOBALS['dataTool']['Tasks']['dri_subworkflow_id'] = ['skip' => true];
$GLOBALS['dataTool']['Tasks']['dri_subworkflow_template_id'] = ['skip' => true];
$GLOBALS['dataTool']['Tasks']['dri_workflow_task_template_id'] = ['skip' => true];
