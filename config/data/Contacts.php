...
$GLOBALS['dataTool']['Contacts']['facebook'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['twitter'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['googleplus'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['department'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['do_not_call'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['phone_home'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['phone_mobile'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['phone_other'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['phone_fax'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['assistant'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['assistant_phone'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['lead_source'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['dnb_principal_id'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['reports_to_id'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['birthdate'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['preferred_language'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['dp_business_purpose'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['dp_consent_last_updated'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['campaign_id'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['mkto_sync'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['mkto_id'] = ['skip' => true];
$GLOBALS['dataTool']['Contacts']['mkto_lead_score'] = ['skip' => true];
