...
Options
    ...
    --profile           Name of file in folder config/profiles or path to php-config-file with profile data.
...
if (isset($opts['profile'])) {
    ...
    } elseif (is_file(PROFILES_DIR . '/' . $opts['profile'])) {
        require_once PROFILES_DIR . '/' . $opts['profile'];
    } else {
